...
export const GlobalContextProvider = ({ children }) => {
  ...
  const [
    ...
    setData_nascimentoProfissionalValid,
  ] = useState(false);
  const [
    data_nascimentoProfissionalValidHover,
    setData_nascimentoProfissionalHover,
  ] = useState(false);
  ...
  const [telefoneProfissionalValid, setTelefoneProfissionalValid] =
    useState(false);
  const [telefoneProfissinalHover, setTelefoneProfissionalHover] =
    useState(false);
  ...
  return (
    <GlobalContext.Provider
      value={{
        ...
        setData_nascimentoValid,
        data_nascimentoHover,
        setData_nascimentoHover,
        cpfValid,
        setCpfValid,
        cpfHover,
        setCpfHover,
        ...
        setNomeProfissionalValid,
        nome_profissinalHover,
        setNomeProfissionalHover,
        cpfProfissionalValid,
        setCpfProfissionalValid,
        cpfProfissionalHover,
        setCpfProfissionalHover,
        telefoneProfissionalValid,
        setTelefoneProfissionalValid,
        telefoneProfissinalHover,
        setTelefoneProfissionalHover,
        emailProfissionalValid,
        setEmailProfissionalValid,
        emailProfissionalHover,
        setEmailProfissonalHover,
        senhaProfissionalValid,
        setSenhaProfissionalValid,
        senhaProfissionalHover,
        setSenhaProfissionalHover,
        erros_passar,
        setErros_passar,
        checkbox_cheked,
        setcheckbox_cheked,
